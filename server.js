...
setInterval(() => {
  http.get(`http://terretri.herokuapp.com/`);
}, 900000);
...
app.get("/invite", function (request, response) {
  response.redirect("https://discord.com/oauth2/authorize?client_id=687969316884447260&scope=bot&permissions=8");
});

app.get("/support", function (request, response) {
  response.redirect("https://discord.gg/RCNkXaC");
});
